...
public class MessageInputView extends RelativeLayout {
     ...
     */
    final String TAG = com.getstream.sdk.chat.view.MessageInputView.class.getSimpleName();
     ...
     */
    private com.getstream.sdk.chat.view.MessageInputView.PermissionRequestListener permissionRequestListener;
    /**
...
//                });
    ...
    public void setPermissionRequestListener(com.getstream.sdk.chat.view.MessageInputView.PermissionRequestListener l) {
